...
from app.services.whatsapp import notify_status_whatsapp
...
def update_status(
    ...
    if tenant:
        ...
        tracking_url = f"{settings.public_app_url.rstrip('/')}/track/{tracking}"
        ...
        notify_tenant(user.tenant_id, "status_change", {
