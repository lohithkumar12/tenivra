  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 px-4">
      <Card className="max-w-md w-full p-8 text-center">
        <div className={`w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center ${isConfirmed ? "bg-emerald-100" : "bg-brand-100"}`}>
          <svg className={`w-10 h-10 ${isConfirmed ? "text-emerald-600" : "text-brand-600"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {trackCode && (
          <div className="mt-6 bg-gradient-to-r from-brand-50 to-violet-50 border border-brand-100 rounded-2xl p-5">
            <p className="text-xs text-slate-500 uppercase tracking-wider font-semibold mb-1">Tracking Code</p>
            <p className="text-2xl font-mono font-bold text-brand-700 tracking-widest">{trackCode}</p>
