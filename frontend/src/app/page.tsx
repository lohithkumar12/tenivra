...
const FEATURES = [
  { icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4", title: "Your Own Clinic Page", desc: "Get a dedicated clinic page with your branding, services, and team — ready to share with patients." },
  { icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z", title: "AI Patient Assistant", desc: "Patients ask questions about timings, fees, and services — and get instant answers, 24/7." },
  { icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z", title: "Online Appointments", desc: "Patients book appointments online. You confirm, reschedule, or manage from your dashboard." },
  { icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z", title: "Doctor Profiles", desc: "Showcase your doctors with specializations, availability, consultation fees, and bios." },
  { icon: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9", title: "Instant Notifications", desc: "Real-time alerts via WhatsApp, email, and browser — for both clinics and patients." },
  { icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4", title: "Live Appointment Tracking", desc: "Patients track their appointment status live — like tracking a food delivery, but for healthcare." },
];
...
export default function HomePage() {
  return (
    <div className="min-h-screen">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 p-12 sm:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link href="/signup">
                  <Button size="xl" variant="secondary" className="!bg-white !text-brand-700 hover:!bg-brand-50 shadow-xl font-bold">Get Started Free</Button>
                </Link>
                <Link href="/clinics">
                  <Button size="xl" variant="ghost" className="text-white border border-white/30 hover:bg-white/10">Browse Clinics</Button>
                </Link>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-surface-900 text-white py-12 sm:py-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-10">
            <div className="col-span-2">
              <h3 className="text-xl font-bold mb-3">Tenivra</h3>
              <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
                Helping clinics across India go digital — with online appointments, instant notifications, and an AI-powered patient assistant. Simple, affordable, and built for you.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-sm uppercase tracking-wider text-slate-400 mb-4">Get Started</h4>
              <ul className="space-y-2.5 text-sm text-slate-300">
                <li><Link href="/clinics" className="hover:text-white transition-colors">Find a Clinic</Link></li>
                <li><Link href="/signup" className="hover:text-white transition-colors">Register Your Clinic</Link></li>
                <li><Link href="/patient/signup" className="hover:text-white transition-colors">Patient Sign Up</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-slate-300">
                ...
                <li><Link href="/refund-policy" className="hover:text-white transition-colors">Cancellation & Refunds</Link></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-white/10 mt-10 sm:mt-12 pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-slate-500">
            <p>&copy; {new Date().getFullYear()} Tenivra. All rights reserved.</p>
            <p>Made in India</p>
          </div>
        </div>
      </footer>
